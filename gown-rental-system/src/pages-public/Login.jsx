...
const Login = ({ onLoginSuccess }) => {
  ...
  const handleUserSessionRouting = async (session) => {
    ...
    // ================= [HARDCORE DEVELOPER OVERRIDE BYPASS] =================

    if (userEmail === 'rjnovicio143@gmail.com') {

      console.warn("🎯 Admin Email detected! Triggering local provisioning bypass pathway...");

     

      localStorage.setItem('userToken', '4bcbef99-b201-40a0-84d5-df1b75f13e78'); // Imong Static Admin Token/ID
